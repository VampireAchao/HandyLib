...
public class CStatsMetrics {
    ...
    static {
        ...
        if (System.getProperty("cStats.relocatecheck") == null || !System.getProperty("cStats.relocatecheck").equals("false")) {
            ...
            if (CStatsMetrics.class.getPackage().getName().equals(defaultPackage) || CStatsMetrics.class.getPackage().getName().equals(examplePackage)) {
     ...
     */
    public CStatsMetrics(Plugin plugin) {
        if (plugin == null) {
        ...
        if (enabled) {
            ...
            Bukkit.getServicesManager().register(CStatsMetrics.class, this, plugin, ServicePriority.Normal);
            if (!found) {
                // We are the first!
                startSubmitting();
            }
